...
This global tech layoffs Power BI dashboard is built on real-world dataset. The dashboard helps us to analyze the trend of tech layoffs in different industies between 2020 - 2025. The dashboard contains of three page Overview, Detailed Overview and Company & Country with different charts and visual, which makes anyone to easily understand the raw data to meaningful insights.
